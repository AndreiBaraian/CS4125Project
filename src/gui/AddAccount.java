...
public class AddAccount extends JFrame {
	...
	public AddAccount(Control c,JTable table) {
		...
		btnAdd.addActionListener(new DoneAddingListener(c,typeCB,sexCB,nameTF,numberTF,addressTF,ageTF,emailTF,regionCB,endDateTF,table));
